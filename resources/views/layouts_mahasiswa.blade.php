            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    ...
                    @if (Auth::user()->profil != 0)
                        <img class="img-profile rounded-circle" src="{{ asset(Auth::user()->profil) }}"
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                    <a class="dropdown-item {{ $title == 'Profil' ? 'active' : '' }}"
                        href="/profil_admin/{{ Auth::user()->id }}">
                        <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                        Profile
                    </a>
                    <div class="dropdown-divider"></div>
                ...
                <div class="sidebar-menu">
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ $title == 'Manajemen Lomba' ? 'active' : '' }}">
                            <a href="user_lomba" class='sidebar-link'>
                                <i class="fa-solid fa-medal"></i>
                                <span>Manajemen Perlombaan</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item {{ ($title == "Perolehan Prestasi") ? 'active' : '' }}">
                            <a href="user_prestasi" class='sidebar-link'>
                                <i class="fa-solid fa-trophy"></i>
                                <span>Perolehan Prestasi</span>
                            </a>
                        </li>
